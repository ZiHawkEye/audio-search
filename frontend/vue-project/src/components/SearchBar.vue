...
<template>
   <input id="search-bar" type="text" v-model="input" placeholder="Search transcriptions..." />
  <div class="item transcription" v-for="transcription in filteredList()" :key="transcription">
    <p>{{ transcription }}</p>
  </div>
